...
class Utils:
    ...
    disk = [pygame.image.load('./Asset/disk/disk0.png'),pygame.image.load('./Asset/disk/disk1.png'),pygame.image.load('./Asset/disk/disk2.png'),pygame.image.load('./Asset/disk/disk3.png'),pygame.image.load('./Asset/disk/disk4.png')]
